...
<p align="center">
  ...
  <p align="center">
    一个简单的嵌入式操作系统,超小!
    <br />
    <a href="https://github.com/peach-1s-me/CatOS/doc"><strong>探索本项目的文档 »</strong></a>
    <br />
    <br />
    <a href="https://github.com/peach-1s-me/CatOS/projects">查看Demo</a>
    ·
...
也可以使用 vscode 的调试支持使用 openocd，更方便，需要下载 [Cortex-Debug](https://marketplace.visualstudio.com/items?itemName=marus25.cortex-debug) 插件并在 lunch.json中创建配置：
```json
"configurations": [
        {
            "cwd": "${workspaceRoot}",
...
该项目签署了 Apache 授权许可，详情请参阅 [LICENSE.txt](https://github.com/peach-1s-me/CatOS/blob/master/LICENSE.txt)
...
[license-url]: https://github.com/peach-1s-me/CatOS/blob/master/LICENSE.txt
